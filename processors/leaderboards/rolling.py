...
def calculate_rolling_woba(
    df: pd.DataFrame, is_pitcher: bool = False, windows: list[int] = None
) -> pd.DataFrame:
    if windows is None:
        windows = [25, 50, 100]
    ...
    return all_results.rename(columns={"batter_id": "player_id", "pitcher_id": "player_id"})
